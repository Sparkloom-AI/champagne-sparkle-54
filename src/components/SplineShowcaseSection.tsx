      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="w-full h-[600px] bg-sl-obsidian/80 relative overflow-hidden border-sl-iron-600/30">
          ...
          <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10">
            <button 
              className="inline-flex items-center gap-2 px-4 py-2 bg-sl-auric-700/10 border border-sl-auric-700/30 rounded-lg backdrop-blur-sm hover:bg-sl-auric-700/20 transition-colors cursor-pointer"
              onClick={() => {
