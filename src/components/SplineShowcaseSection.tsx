...
export function SplineShowcaseSection() {
  return <section className="py-20 bg-gradient-to-b from-background to-sl-obsidian/30">
            ...
            <div className="flex-1 p-8 lg:p-12 relative z-10 flex flex-col justify-center">
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sl-auric-700 font-semibold">Ready for a Discovery Call? </span>
                </div>
