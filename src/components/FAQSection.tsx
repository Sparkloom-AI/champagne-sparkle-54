...
const FAQSection = () => {
  ...
  return (
    <section className="py-20 bg-sl-obsidian relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/3 space-y-6">
            ...
            <Button 
              variant="ghost" 
              className="text-sl-pearl-100 hover:text-sl-auric-700 p-0 h-auto font-normal group"
              onClick={() => {
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqs.map((faq, index) => (
                <AccordionItem 
                  key={index} 
                  value={`item-${index}`}
                  className="border-sl-iron-600/30 bg-sl-obsidian/50 rounded-lg px-6"
                >
