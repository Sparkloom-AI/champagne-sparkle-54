...
const Careers = () => {
  ...
  const teamMembers = [
    { image: teamMember1, position: "top-16 right-16", size: "w-40 h-40" },
    { image: teamMember2, position: "top-40 right-72", size: "w-36 h-36" },
    { image: teamMember3, position: "bottom-40 right-96", size: "w-44 h-44" },
    { image: teamMember4, position: "top-32 right-32", size: "w-64 h-64" },
    { image: teamMember5, position: "bottom-16 right-48", size: "w-48 h-48" },
    { image: teamMember6, position: "top-72 right-80", size: "w-40 h-40" }
  ];
